/**
 * Bundle-age nudge (P22 — update incentive).
 *
 ...
 *
 * Distinguished from the 30-day "stale profile" badge (public,
...
export function maybeShowBundleNudge(): void {
  ...
  process.stderr.write(
    `\n→ Your bundle is ${days} day${days === 1 ? "" : "s"} old.\n` +
    `  Refresh to enrich your growth curve: beheld snapshot\n\n`,
  );
